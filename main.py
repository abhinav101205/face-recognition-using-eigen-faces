...
# Loading  oof training images from the path
...
#showing all images in a grid style way
...
# Preprocessing stage of training images taken as input from the folder path
if len(images) > 0:
...
# seeing what images are matching in the training set with the testing images (the cloasest match)
